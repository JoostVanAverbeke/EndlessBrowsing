...
@Component({
  selector: 'app-infinite-scroll-table-demo',
  templateUrl: './infinite-scroll-table-demo.component.html',
  styleUrls: ['./infinite-scroll-table-demo.component.scss']
})
export class InfiniteScrollTableDemoComponent implements OnInit, AfterViewInit {
